...
export const soundTrackMap = {
  iceworld: "iceworld.ogg",
  mycelium: "mycelium.ogg",
  ascend: "ascend.ogg",
  bioluminescence: "bioluminescence.ogg",
  "yeast soup": "yeast soup.ogg",
} as const;

export const soundEventMap = {
  jump: "jump.ogg",
  punchAir: "punchAir.ogg",
  punch: "punch.ogg",
  itemPickup: "itemPickup.ogg",
  pistolShot: "pistol_shot.ogg",
  shotgunShot: "shotgun_shot.ogg",
  bazookaShot: "bazooka_rocket_launch.ogg",
  bazookaExplosion: "bazooka_rocket_explosion.ogg",
  hit: "hit.ogg",
  blaster: "blaster.ogg",
  bullet: "bullet.ogg",
  heal: "heal.ogg",
  clientConnect: "clientConnect.ogg",
  revive: "revive.ogg",
  death: "death.ogg",
  sniperBullet: "sniperBullet.ogg",
  instagibBullet: "instagib.ogg",
